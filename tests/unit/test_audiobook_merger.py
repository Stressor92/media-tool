...
class TestMergeAudiobookChapters:
    ...
    def test_merge_ffmpeg_failure(self, tmp_media_dir):
        ...
        with patch("utils.ffmpeg_runner.run_ffmpeg") as mock_ffmpeg:
            mock_ffmpeg.return_value = FFmpegResult(
                success=False, return_code=1, command=[], stderr_bytes=b"FFmpeg error", stdout_bytes=b""
            )
...
class TestMergeAudiobookLibrary:
    ...
    def test_merge_library_success(self, tmp_path):
        ...
        with (
            ...
            mock_detect.return_value = {
                "Book One": [
                    (book1_dir / "Book One - Chapter 01.mp3", 1),
                    (book1_dir / "Book One - Chapter 02.mp3", 2),
                ],
                "Book Two": [
                    (book2_dir / "Book Two - Chapter 01.mp3", 1),
                    (book2_dir / "Book Two - Chapter 02.mp3", 2),
                ],
            }
    ...
    def test_merge_library_mixed_success_failure(self, tmp_path):
        ...
        with (
            ...
            mock_detect.return_value = {
                "Book One": [
                    (input_dir / "Book One - Chapter 01.mp3", 1),
                    (input_dir / "Book One - Chapter 02.mp3", 2),
                ],
                "Book Two": [
                    (input_dir / "Book Two - Chapter 01.mp3", 1),
                    (input_dir / "Book Two - Chapter 02.mp3", 2),
                ],
            }
