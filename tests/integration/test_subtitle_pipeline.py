...
""")
        ...
        mock_sync.return_value = type(
            "MockSyncResult", (), {"success": True, "srt_path": srt_path, "scale_factor": 1.0, "error_message": None}
        )()
        mock_optimize.return_value = srt_path
        mock_mux.return_value = type("MockResult", (), {"success": True, "output_file": Path("output.mkv")})()
    ...
    def test_pipeline_audio_extraction_failure(self, mock_extract, test_video_720p):
        ...
        mock_extract.return_value = type(
            "MockResult", (), {"success": False, "error_message": "Audio extraction failed"}
        )()
    ...
    def test_pipeline_mux_failure(self, mock_mux, mock_extract, mock_run_whisper, test_video_720p, test_audio_wav):
        ...
        mock_extract.return_value = type(
            "MockResult", (), {"success": True, "wav_path": test_audio_wav, "duration": 10.0}
        )()
        ...
        mock_mux.return_value = type("MockResult", (), {"success": False, "error_message": "Muxing failed"})()
