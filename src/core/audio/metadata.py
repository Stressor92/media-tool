...
class AudioMetadataEnhanced(AudioMetadata):
    ...
    parsed_track_number: int | None = None
...
def _query_musicbrainz(artist: str, title: str, album: str | None = None) -> dict[str, str | None]:
    """
    ...
    try:
        ...
        result = musicbrainzngs.search_recordings(artist=artist, recording=title, release=album, limit=1)
